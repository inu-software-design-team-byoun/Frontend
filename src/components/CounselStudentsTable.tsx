...
// import SearchIcon from "../assets/icon/SearchIcon.svg?url";
...
const SearchArea = styled.div`
  ...
  input {
    /* width: 188px; // padding이 없을 때 원래 넓이 */
    width: 132px;
    height: 2.25rem;
...
export const CounselStudentsTable: React.FC<CounselStudentsTableProps> = ({
  ...
  return (
    <Wrapper>
      ...
      <SearchArea>
        <input placeholder="검색어 입력 + Enter"></input>
        {/* <input placeholder="검색어 입력 + Enter" /> */}
      </SearchArea>
      <TableWrapper>
        <StyledTable>
          <colgroup>
